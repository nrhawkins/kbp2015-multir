 ...
 *
 */
public class DefaultFeatureGeneratorNoCJ implements FeatureGenerator {
	...
	public List<String> generateFeatures(Integer arg1StartOffset,
		...
		//System.out.println("dfg tokens: " + tokens.size());
		...
		for(int i =0; i < tokens.size(); i++){
			...
			int sentStartOffset2 = tokens.get(0).beginPosition();
			int begOffset = token.beginPosition() - sentStartOffset2;
			int endOffset = token.endPosition() - sentStartOffset2;
			...
			//These are identical: begOffset and begOffset2, and endOffset and endOffset2
			//System.out.println("dfg: " + begOffset + " " + endOffset);
			//System.out.println("dfg: " + begOffset2 + " " + endOffset2);
		...
		//System.out.println("dfg dependency conversions: ");
...
//		}
		...
		//System.out.println("dfg tokenStrings: " + tokenStrings.length);
		//System.out.println("dfg posTags: " + posTags.length);
		//System.out.println("dfg depParents: " + depParents.length);
		//System.out.println("dfg depTypes: " + depTypes.length);
		//System.out.println("dfg arg1Pos: " + arg1Pos.length);
		//System.out.println("dfg arg2Pos: " + arg2Pos.length);
		//System.out.println("dfg arg1ner: " + arg1ner);
		//System.out.println("dfg arg2ner: " + arg2ner);
