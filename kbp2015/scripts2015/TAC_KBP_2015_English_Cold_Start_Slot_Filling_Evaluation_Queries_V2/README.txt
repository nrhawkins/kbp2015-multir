   TAC KBP 2015 English Cold Start Slot Filling Evaluation Queries V2.0
...
Offsets corresponding to 1006 queries pulled from documents in
LDC2015E77 starting with "ENG_NW_" were decremented by 39. In earlier
versions of this release, offsets were incorrectly counted starting
from the XML declaration at the beginning of those docs, instead of
the opening <DOC> tag.  The query ID for these 1006 queries have also
changed, because they are generated from a combination of variables
including the offsets.

The extraneous characters "amp;" were removed from the <name> of 34
queries.  In earlier versions of this release, the string "&amp;" in
the source document appeared as "&amp;amp;" in the queries.
